      ...
      <div className="border border-gray-200 rounded-lg p-4 bg-white w-full lg:max-w-sm shadow-sm font-sans h-fit">
         ...
         <div className="mb-4 relative">
            ...
            <div className="flex gap-3 mb-4 border-b border-gray-200 pb-4">
               <a href={`mailto:${data.socials.find(s => s.name === 'Email')?.url}`} className="group cursor-pointer" title="Email">
               ...
               <a href={data.socials.find(s => s.name === 'LinkedIn')?.url} target="_blank" rel="noreferrer" className="group cursor-pointer" title="LinkedIn">
                  <div className="w-10 h-10 rounded-full flex items-center justify-center bg-gray-100 group-hover:bg-gray-200 text-gray-700 transition-colors">
               ...
               <a href={data.socials.find(s => s.name === 'GitHub')?.url} target="_blank" rel="noreferrer" className="group cursor-pointer" title="GitHub">
                  <div className="w-10 h-10 rounded-full flex items-center justify-center bg-gray-100 group-hover:bg-gray-200 text-gray-700 transition-colors">
                     <svg className="w-[18px] h-[18px]" fill="currentColor" viewBox="0 0 24 24">
               ...
               <a href={data.socials.find(s => s.name === 'Portfolio')?.url} target="_blank" rel="noreferrer" className="group cursor-pointer" title="Website">
                  <div className="w-10 h-10 rounded-full flex items-center justify-center bg-gray-100 group-hover:bg-gray-200 text-gray-700 transition-colors">
               ...
               <a href={data.socials.find(s => s.name === 'Medium')?.url} target="_blank" rel="noreferrer" className="group cursor-pointer" title="Medium">
                  <div className="w-10 h-10 rounded-full flex items-center justify-center bg-gray-100 group-hover:bg-gray-200 text-gray-700 transition-colors">
                     <svg className="w-[18px] h-[18px]" fill="currentColor" viewBox="0 0 24 24">
